...
* Gebruik een komma (geen punt) om een kommagetal in te geven.
...
# Voorbeeld
![example](https://github.com/howest-gp-prb/pe01-expresso-oplossing/blob/master/screens/coffeeflow.gif?raw=true)
